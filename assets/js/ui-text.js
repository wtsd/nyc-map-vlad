(() => {
  const TEXT = {
    en: {
      ...
      addressPin: "Pin address",
      addressSearching: "Searching for address...",
      addressFound: "Pinned address on the map.",
      addressNotFound: "Address not found. Try adding city or ZIP code.",
      addressSearchError: "Could not search for this address. Please try again.",
      addressEmpty: "Enter an address to add a pin.",
    ...
    ru: {
      ...
      addressPin: "Поставить пин",
      addressSearching: "Ищем адрес...",
      addressFound: "Адрес отмечен на карте.",
      addressNotFound: "Адрес не найден. Попробуйте добавить город или индекс.",
      addressSearchError: "Не удалось найти этот адрес. Попробуйте еще раз.",
      addressEmpty: "Введите адрес, чтобы поставить пин.",
